import { openApiInfo, openApiServers, securitySchemes } from './config.js';
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      ...
                      kv: { type: 'string', example: 'connected' },
                      runtime: {
                        type: 'object',
                        properties: {
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      ...
                      name: { type: 'string', example: 'gruff' },
      ...
      '/api/types': {
        post: {
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/CreateType' },
              },
            },
          },
          responses: {
        ...
        get: {
          ...
          parameters: [
            {
              ...
              schema: { type: 'string', enum: ['entity', 'link'] },
            },
            {
              name: 'name',
              in: 'query',
          ...
          responses: {
            200: {
              ...
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/PaginatedTypesResponse' },
                },
              },
            },
          },
      ...
      '/api/types/{id}': {
        ...
        put: {
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/UpdateType' },
              },
            },
          },
          responses: {
        ...
        get: {
          ...
          responses: {
            200: {
              ...
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/PaginatedLinksResponse' },
                },
              },
            },
          },
        ...
        get: {
          ...
          parameters: [
            { $ref: '#/components/parameters/id' },
            {
              ...
              schema: { type: 'string', enum: ['outbound', 'inbound', 'both'], default: 'both' },
            },
            {
              name: 'link_type_id',
              in: 'query',
      ...
      '/api/graph/traverse': {
        post: {
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/TraversalRequest' },
              },
            },
          },
          responses: {
      ...
      '/api/search/entities': {
        post: {
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/SearchEntities' },
              },
            },
          },
          responses: {
      ...
      '/api/search/links': {
        post: {
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/SearchLinks' },
              },
            },
          },
          responses: {
      ...
      '/api/bulk/entities': {
        post: {
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/BulkCreateEntities' },
              },
            },
          },
          responses: {
        ...
        put: {
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/BulkUpdateEntities' },
              },
            },
          },
          responses: {
      ...
      '/api/bulk/links': {
        post: {
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/BulkCreateLinks' },
              },
            },
          },
          responses: {
        ...
        put: {
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/BulkUpdateLinks' },
              },
            },
          },
          responses: {
        ...
        get: {
          ...
          parameters: [
            ...
            },
            {
              ...
              schema: { type: 'string', default: '1000' },
            },
          ],
          responses: {
            200: {
        ...
        get: {
          ...
          parameters: [
            ...
            },
            {
              ...
              schema: { type: 'string', enum: ['entity', 'link', 'type', 'user'] },
            },
            {
              name: 'resource_id',
              in: 'query',
            ...
            },
            {
              ...
              schema: { type: 'string', enum: ['create', 'update', 'delete', 'restore'] },
            },
            {
              name: 'start_date',
              in: 'query',
      ...
      schemas: {
        ...
        User: {
          ...
          properties: {
            ...
            provider: { type: 'string', enum: ['local', 'google', 'github', 'microsoft', 'apple'] },
        ...
        CreateType: {
          ...
          properties: {
            name: { type: 'string', minLength: 1, maxLength: 255, example: 'Person' },
            category: { type: 'string', enum: ['entity', 'link'] },
            description: { type: 'string', maxLength: 1000 },
            json_schema: { type: 'object', description: 'JSON Schema for property validation' },
          },
        },
        UpdateType: {
          type: 'object',
          properties: {
            ...
            json_schema: { type: 'object', nullable: true },
          },
        },
        Type: {
          type: 'object',
        ...
        CreateEntity: {
          ...
          required: ['type_id'],
          properties: {
            type_id: { type: 'string', format: 'uuid', description: 'Entity type ID' },
            properties: { type: 'object', default: {}, description: 'Custom JSON properties' },
          },
        },
        UpdateEntity: {
          type: 'object',
        ...
        CreateLink: {
          ...
          properties: {
            type_id: { type: 'string', format: 'uuid', description: 'Link type ID' },
            source_entity_id: { type: 'string', format: 'uuid', description: 'Source entity ID' },
            target_entity_id: { type: 'string', format: 'uuid', description: 'Target entity ID' },
        ...
        SearchEntities: {
          ...
          properties: {
            type_id: { type: 'string', format: 'uuid' },
            properties: { type: 'object', description: 'Simple equality filters (deprecated)' },
            property_filters: {
              type: 'array',
              items: { $ref: '#/components/schemas/PropertyFilter' },
              description: 'Advanced property filters',
            },
            filter_expression: { type: 'object', description: 'Complex AND/OR filter expression' },
        ...
        TraversalRequest: {
          ...
          properties: {
            ...
            link_types: { type: 'array', items: { type: 'string', format: 'uuid' } },
            entity_types: { type: 'array', items: { type: 'string', format: 'uuid' } },
            ...
            entities: {
              ...
              items: {
                ...
                properties: {
                  type_id: { type: 'string', format: 'uuid' },
                  properties: { type: 'object', default: {} },
                  client_id: { type: 'string', description: 'Optional client ID for correlation' },
                },
              },
            },
          },
        ...
        ExportResponse: {
          type: 'object',
          properties: {
            format_version: { type: 'string', example: '1.0' },
            exported_at: { type: 'string', format: 'date-time' },
            types: { type: 'array', items: { $ref: '#/components/schemas/Type' } },
            entities: { type: 'array', items: { $ref: '#/components/schemas/Entity' } },
            links: { type: 'array', items: { $ref: '#/components/schemas/Link' } },
            metadata: {
              type: 'object',
            ...
            links: {
              ...
              items: {
                ...
                properties: {
                  ...
                  type_id: { type: 'string', format: 'uuid' },
                  type_name: { type: 'string' },
                  source_entity_client_id: { type: 'string' },
                  source_entity_id: { type: 'string', format: 'uuid' },
                  target_entity_client_id: { type: 'string' },
                  target_entity_id: { type: 'string', format: 'uuid' },
                  properties: { type: 'object' },
                },
              },
        ...
        ImportResponse: {
          ...
          properties: {
            ...
            data: {
              type: 'object',
              properties: {
                type_results: { type: 'array', items: { type: 'object' } },
                entity_results: { type: 'array', items: { type: 'object' } },
                link_results: { type: 'array', items: { type: 'object' } },
                id_mapping: {
                  type: 'object',
                  properties: {
                    types: { type: 'object' },
        ...
        AuditLog: {
          ...
          properties: {
            ...
            resource_type: { type: 'string', enum: ['entity', 'link', 'type', 'user'] },
        ...
        PaginatedTypesResponse: {
          ...
          properties: {
            ...
            data: {
              type: 'object',
              properties: {
                items: { type: 'array', items: { $ref: '#/components/schemas/Type' } },
                next_cursor: { type: 'string', nullable: true },
                total: { type: 'integer' },
              },
            },
