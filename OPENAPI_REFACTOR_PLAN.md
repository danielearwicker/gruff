...
- [x] **Convert PUT /api/entities/:id/acl** - Sets ACL permissions. Test: Update ACL
...
- [x] **Convert GET /api/links** - Lists links with ACL filtering. Test: List links
- [x] **Convert GET /api/links/:id** - Gets link by ID. Test: Get specific link
- [x] **Convert PUT /api/links/:id** - Updates link (creates new version). Test: Update link
- [x] **Convert DELETE /api/links/:id** - Soft-deletes link. Test: Delete link
...
- [x] **Convert PUT /api/links/:id/acl** - Sets ACL permissions. Test: Update ACL
...
- [x] **Convert GET /api/graph/path** - Finds shortest path between entities. Test: Find path between two entities
- [x] **Convert GET /api/graph/entities/:id/graph-view** - Gets graph visualization data. Test: Get graph view for entity
...
- [x] **Convert search router to OpenAPIHono** - Change to `new OpenAPIHono()` in `src/routes/search.ts`
...
- [x] **Convert GET /api/search/suggest** - Type-ahead suggestions. Test: Get suggestions for partial query
...
- [x] **Convert users router to OpenAPIHono** - Change to `new OpenAPIHono()` in `src/routes/users.ts`
...
- [x] **Convert GET /api/users/:id** - Gets user profile. Test: Get user by ID
- [x] **Convert PUT /api/users/:id** - Updates user (admin or self). Test: Update user
...
- [x] **Update README** - Document OpenAPI at `/docs`, spec at `/docs/openapi.json`, client generation
